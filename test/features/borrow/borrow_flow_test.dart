...
void main() {
  testWidgets('borrow confirm is rejected because LTV quote is stale', (
    tester,
  ) async {
    ...
    await tester.tap(find.byKey(const Key('borrow_confirm')));
    await tester.pumpAndSettle();
    ...
    expect(find.byKey(const Key('borrow_result')), findsOneWidget);
